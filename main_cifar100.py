...
id = randint(0, 1000)
logdir = os.path.join(save_dir, 'cifar100', model_name+'18'+'_zcapi8group', '{}-bs{}'.format(norm, BatchSize), str(id))  # _bn _1layer95pct29pi
# _zcapi4group100pct19pi, _zcapi8group100pct19pi-debug,  _zcapi1group
